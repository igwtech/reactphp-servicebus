...
/*
 * This file is derived work from Composer.
 *
 * (c) Nils Adermann <naderman@naderman.de>
 *     Jordi Boggiano <j.boggiano@seld.be>
 *      Javier Munoz <javier@greicodex.com>
 *
 ...
 * @author Javier Munoz <javier@greicodex.com>
 */
class Compiler
{
    /**
...
EOF;
        ...
        if (preg_match('{^[a-f0-9]+$}', $this->version)) {
            ...
            $stub .= "define('LIBRARY_DEV_WARNING_TIME', $warningTime);\n";
        }
